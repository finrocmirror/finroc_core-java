...
public interface Method2Handler<R, P1, P2> extends AbstractMethodCallHandler {
     ...
     */
    @NonVirtual
    public abstract R handleCall(@Const @Ptr AbstractMethod method, @AtFront P1 p1, @AtFront P2 p2) throws MethodCallException;
}
