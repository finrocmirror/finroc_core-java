...
public interface Void4Handler<P1, P2, P3, P4> extends AbstractMethodCallHandler {
     ...
     */
    @NonVirtual
    public abstract void handleVoidCall(@Const @Ptr AbstractMethod method, @AtFront P1 p1, @AtFront P2 p2, @AtFront P3 p3, @AtFront P4 p4) throws MethodCallException;
}
