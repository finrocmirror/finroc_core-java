...
@DefaultType("void*") @Ptr @Inline @NoCpp @RawTypeArgs @Superclass2( {"PortListenerAdapter<T, typeutil::IsCCType<T>::value, boost::is_integral<T>::value || boost::is_floating_point<T>::value>"})
