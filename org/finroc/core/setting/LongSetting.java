...
public class LongSetting extends Setting implements CCPortListener<CoreNumber> {
    ...
    public LongSetting(String description, long defaultVal, boolean publishAsPort, Unit unit, Bounds bounds) {
