...
public class DoubleSetting extends Setting implements CCPortListener<CoreNumber> {
    ...
    public DoubleSetting(String description, double defaultVal, boolean publishAsPort, Unit unit, Bounds bounds) {
