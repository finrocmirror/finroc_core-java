...
public interface Void0Handler extends AbstractMethodCallHandler {
     ...
     */
    @NonVirtual
    public abstract void handleVoidCall(@Const @Ptr AbstractMethod method) throws MethodCallException;
}
