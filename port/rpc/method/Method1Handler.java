...
public interface Method1Handler<R, P1> extends AbstractMethodCallHandler {
     ...
     */
    @NonVirtual
    public abstract R handleCall(@Const @Ptr AbstractMethod method, @AtFront P1 p1) throws MethodCallException;
}
