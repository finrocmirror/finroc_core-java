...
public interface Void1Handler<P1> extends AbstractMethodCallHandler {
     ...
     */
    @NonVirtual
    public abstract void handleVoidCall(@Const @Ptr AbstractMethod method, @AtFront P1 p1) throws MethodCallException;
}
